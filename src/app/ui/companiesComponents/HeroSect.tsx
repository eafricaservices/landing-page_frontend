...
const HeroSect = () => {
return (
    <section className={`${roboto_condensed.className} relative mt-12 md:mt-23  mx-auto max-w-[90%] md:max-w-[80%]  flex flex-col items-center justify-center text-center bg-white text-black space-y-17 md:space-y-23`}>
 ...
 <div className="relative mx-auto mt-3 max-w-full overflow-hidden rounded-sm border bg-neutral-100">
  <Image
    width={1200}
    height={800}
  ...
  />
    ...
    <div className="absolute mx-auto w-xs md:w-lg inset-x-0 z-10 bottom-10 flex justify-center rounded-sm bg-neutral-700  px-2 py-3 md:px-4 md:py-6 text-xs font-medium uppercase tracking-wide text-white shadow-md hover:bg-neutral-800 ">
          ...
          <Link 
            href="/companies/#discovery"
            className='text-white font-bold text-sm md:text-2xl'>
          <Button className='text-white font-bold text-sm md:text-xl'>
